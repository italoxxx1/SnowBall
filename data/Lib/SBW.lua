...
SBW_AREA = {{x = 1151, y = 725, z = 7}, {x = 1190, y = 764, z = 7}}-- AREA DO EVENTO | Canto superior esquerdo / inferior direito
SBW_WAITROOM = {{x = 1166, y = 740, z = 6}, {x = 1174, y = 748, z = 6}} -- AREA DE ESPERA | Canto superior esquerdo / inferior direito
...
SBW_TPEND = {x = 656, y = 408, z = 7} -- local onde serao teleport ao final do evento
SBW_GERADOR = {x = 1770, y = 774, z = 7} -- local onde gerador vai ficar
